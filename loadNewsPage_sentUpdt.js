...
xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
            ...
            for (var dataNews in allNewsObj.Data) {
                  ...
                  if(parseInt(allNewsObj.Data[dataNews].id)>latestNewsId)
                  ...
                  newsContent = newsContent + '<li>' +
                        ...
                        '</li>'+
                        '<li><div class="timeline-item-sentiment '+sentClass+'">'+
                        currSentiment+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+'positive=&nbsp;<input type="text" style="color:#000" name="pos">%&nbsp;&nbsp;&nbsp;negative=&nbsp;<input type="text" style="color:#000" name="neg">%'+
                        '</div></li>';
            }
