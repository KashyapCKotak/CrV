  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="text-align:center">
          ...
          <small style="width: 100%;background: #ffa635;border-radius: 50px;width: 80%;margin: 0 auto;color: black;height: 26px;padding: 5px;font-weight:380">let us make the masses notice you...</small>
      </h1>
